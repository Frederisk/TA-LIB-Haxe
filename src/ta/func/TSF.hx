...
@:keep
function TSF(startIndex:Int, endIndex:Int, inReal:Array<Float>, optInTimePeriod:Int) {
    var outBegIndex:Int;
    ...
    while (today <= endIndex) {
        ...
        outReal[outIndex++] = b + m * optInTimePeriod;
        today++;
    }
...
@:keep
function TSFLookback(optInTimePeriod:Int):Int {
    // INTEGER_DEFAULT
    // if(optInTimePeriod == null || ){
    //     optInTimePeriod = 14;
    // } else
