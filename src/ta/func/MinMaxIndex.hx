...
@:keep
function MinMaxIndex(startIndex:Int, endIndex:Int, inReal:Array<Float>, optInTimePeriod:Int) {
    var outBegIndex:Int;
    var outNBElement:Int;
    var outMinIndex:Array<Int> = [];
    var outMaxIndex:Array<Int> = [];
    ...
    while (today <= endIndex) {
        ...
        outMaxIndex[outIndex] = highestIndex;
        outMinIndex[outIndex] = lowestIndex;
        outIndex++;
        trailingIndex++;
        today++;
    }
