...
@:keep
function CdlAbandonedBaby(startIndex:Int, endIndex:Int, inOpen:Array<Float>, inHigh:Array<Float>, inLow:Array<Float>, inClose:Array<Float>,
    ...
    do {
        if (RealBody(i - 2, inOpen, inClose) > CandleAverage(CandleSettingType.BodyLong, BodyLongPeriodTotal, i - 2, inOpen, inHigh, inLow, inClose)
            ...
            && ((CandleColor(i - 2, inOpen, inClose) == 1
                ...
                && CandleGapUp(i - 1, i - 2, inHigh, inLow)
                && CandleGapDown(i, i - 1, inHigh, inLow))
                || (CandleColor(i - 2, inOpen, inClose) == -1
                    && CandleColor(i, inOpen, inClose) == 1
                    && inClose[i] > inClose[i - 2] + RealBody(i - 2, inOpen, inClose) * optInPenetration
                    && CandleGapDown(i - 1, i - 2, inHigh, inLow)
                    && CandleGapUp(i, i - 1, inHigh, inLow)))) {
