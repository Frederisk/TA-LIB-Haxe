...
@:keep
function HtPhasor(startIndex:Int, endIndex:Int, inReal:Array<Float>) {
    var outBegIndex:Int;
    var outNBElement:Int;
    var outInPhase:Array<Float> = [];
    var outQuadrature:Array<Float> = [];
    ...
    lookbackTotal = 32 + Globals.unstablePeriod[FuncUnstId.HtPhasor];
    ...
    while (today <= endIndex) {
        ...
        if ((today % 2) == 0) {
            ...
            if (today >= startIndex) {
                outQuadrature[outIndex] = Q1;
                outInPhase[outIndex++] = I1ForEvenPrev3;
            }
            ...
            if (today >= startIndex) {
                outQuadrature[outIndex] = Q1;
                outInPhase[outIndex++] = I1ForOddPrev3;
            }
