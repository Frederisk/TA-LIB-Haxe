...
@:keep
function Aroon(startIndex:Int, endIndex:Int, inHigh:Array<Float>, inLow:Array<Float>, optInTimePeriod:Int) {
    var outBegIndex:Int;
    var outNBElement:Int;
    var outAroonDown:Array<Float> = [];
    var outAroonUp:Array<Float> = [];

    var lowest:Float, highest:Float, tmp:Float, factor:Float;
    var outIndex:Int;
    ...
    while (today <= endIndex) {
        ...
        outAroonUp[outIndex] = factor * (optInTimePeriod - (today - highestIndex));
        outAroonDown[outIndex] = factor * (optInTimePeriod - (today - lowestIndex));
